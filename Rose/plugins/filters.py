...
Filters are case insensitive; every time someone says your trigger words, Bhanumathi will reply something else! can be used to create your own commands, if desired.
